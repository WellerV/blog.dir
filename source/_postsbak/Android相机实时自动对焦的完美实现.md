...
st=>start: Start
e=>end: End
cond=>condition: 检测手机是否移动
sub1=>subroutine: 对焦
io=>inputoutput: 几秒后

st->cond(yes,right)->sub1
sub1->io(right)->cond
cond(no)->cond
...
具体实现可以参考：
[https://github.com/huweigoodboy/SweetCamera](https://github.com/huweigoodboy/SweetCamera)
